...
/*
Purpose: clean all pointers the program uses
In:
house: house struct that holds all evidence the hunters use and rooms that are in the house

Output: House with everything contained in it freed
*/
...
/*
Purpose: Initialize items in house
Out:
house: house struct to have its contents initialize

Output: House with both list initialized
*/
void initHouse(HouseType* house){
    initEvidenceList(&house->evlist);	//Starts up an empty list for house
    initRoomList(&house->rooms);//needs to be a pointer, fucntion allocates memory to pointer head
}
