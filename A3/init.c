...
Purpose: Initialize Evidence as a helper function
id, room, device, value, timestamp: values to insert in dest
dest: The evidence struct to put values in
*/
...
/*
Function: Initialize variables in dest struct
Purpose: Initialize variables in struct
evArr: Array for evidence 
cap: The cap for the given evArr
*/
